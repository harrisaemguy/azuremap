(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.dc = global.dc || {}, global.dc.jtree = {})));
  ...
  /*jshint -W083 */
  	...
  	$.fn.jstree = function (arg) {
  		...
  		this.each(function () {
  			...
  			if(!instance && !is_method && (arg === undefined$1 || $.isPlainObject(arg))) {
  			...
  			if(result !== null && result !== undefined$1) {
  				return false;
  			}
  		});
  		// if there was a method call with a valid return value - return that, otherwise continue the chain
  		return result !== null && result !== undefined$1 ?
  			result : this;
  	};
  	/**
        ...
        if (obj && $.inArray(obj.id, this._model.changed) === -1) {
  		...
  		_append_json_data : function (dom, data, cb, force_processing) {
  			...
  			var w = null,
  				...
  				inst = this,
  				func = function (data, undefined$1) {
  					...
  					var dat = data.dat,
  						...
  						parse_flat = function (d, p, ps) {
  							...
  							var tid = d.id.toString(),
  								...
  								tmp = {
  									id			: tid,
  									text		: d.text || '',
  									icon		: d.icon !== undefined$1 ? d.icon : true,
  									parent		: p,
  									parents		: ps,
  									children	: d.children || [],
  							...
  							if(tmp.icon === undefined$1 || tmp.icon === null || tmp.icon === "") {
  								tmp.icon = true;
  							}
  							if(d && d.data) {
  								tmp.data = d.data;
  						...
  						parse_nest = function (d, p, ps) {
  							...
  							tmp = {
  								...
  								icon		: typeof d === 'object' && d.icon !== undefined$1 ? d.icon : true,
  								parent		: p,
  								parents		: ps,
  								children	: [],
  								children_d	: [],
  					...
  					if(dat.length && dat[0].id !== undefined$1 && dat[0].parent !== undefined$1) {
  		...
  		_parse_model_from_html : function (d, p, ps) {
  			...
  			if(data.state.icon !== undefined$1) {
  				data.icon = data.state.icon;
  			}
  			if(data.icon === undefined$1 || data.icon === null || data.icon === "") {
  				data.icon = true;
  			}
  		...
  		open_node : function (obj, callback, animation) {
  			...
  			animation = animation === undefined$1 ? this.settings.core.animation : animation;
  		...
  		activate_node : function (obj, e) {
  			...
  			this._data.core.last_clicked = this._data.core.last_clicked && this._data.core.last_clicked.id !== undefined$1 ? this.get_node(this._data.core.last_clicked.id) : null;
  		...
  		set_state : function (state, callback) {
  			if(state) {
  				if(state.core && state.core.selected && state.core.initial_selection === undefined$1) {
  				...
  				if(state.core) {
  					...
  					if(state.core.scroll) {
  						if(state.core.scroll && state.core.scroll.left !== undefined$1) {
  							this.element.scrollLeft(state.core.scroll.left);
  						}
  						if(state.core.scroll && state.core.scroll.top !== undefined$1) {
  					...
  					if(state.core.selected) {
  						_this = this;
  						if (state.core.initial_selection === undefined$1 ||
  							state.core.initial_selection === this._data.core.selected.concat([]).sort().join(',')
  						) {
  							this.deselect_all();
  		...
  		create_node : function (par, node, pos, callback, is_loaded) {
  			...
  			if(node.text === undefined$1) { node.text = this.get_string('New node'); }
  			var tmp, dpc, i, j;
  		...
  		copy_node : function (obj, par, pos, callback, is_loaded, skip_redraw, origin) {
  			...
  			new_par = (!pos.toString().match(/^(before|after)$/) || par.id === $.jstree.root) ? par : this.get_node(par.parent);
  			old_ins = origin ? origin : (this._model.data[obj.id] ? this : $.jstree.reference(obj.id));
  			!old_ins || !old_ins._id || (this._id !== old_ins._id);
  		...
  		set_icon : function (obj, icon) {
  			...
  			if(!obj || obj.id === $.jstree.root) { return false; }
  			old = obj.icon;
  			obj.icon = icon === true || icon === null || icon === undefined$1 || icon === '' ? true : icon;
  			dom = this.get_node(obj, true).children(".jstree-anchor").children(".jstree-themeicon");
  			if(icon === false) {
  				dom.removeClass('jstree-themeicon-custom ' + old).css("background","").removeAttr("rel");
  				this.hide_icon(obj);
  			}
  			else if(icon === true || icon === null || icon === undefined$1 || icon === '') {
  				dom.removeClass('jstree-themeicon-custom ' + old).css("background","").removeAttr("rel");
   ...
   */
  	...
  	$.jstree.plugins.checkbox = function (options, parent) {
  				...
  				this.element
  					...
  					.on(this.settings.checkbox.tie_selection ? 'deselect_node.jstree' : 'uncheck_node.jstree', function (e, data) {
  							var obj = data.node;
  								...
  								var i, j, tmp, s = this.settings.checkbox.cascade, t = this.settings.checkbox.tie_selection,
  								cur = this._data[ t ? 'core' : 'checkbox' ].selected, allIds = obj.children_d.concat(obj.id);
  			...
  			for(i = 0, j = s.length; i < j; i++) {
  				if(m[s[i]] && m[s[i]].parents) {
  					for(k = 0, l = m[s[i]].parents.length; k < l; k++) {
  						if(o[m[s[i]].parents[k]] !== undefined$1) {
  							break;
  						}
  				...
  				.each(function () {
  					...
  					if(!tmp.state.loaded) {
  						if(tmp.original && tmp.original.state && tmp.original.state.undetermined && tmp.original.state.undetermined === true) {
  							if(o[tmp.id] === undefined$1 && tmp.id !== $.jstree.root) {
  								o[tmp.id] = true;
  								p.push(tmp.id);
  							}
  							for(k = 0, l = tmp.parents.length; k < l; k++) {
  								if(o[tmp.parents[k]] === undefined$1 && tmp.parents[k] !== $.jstree.root) {
  						...
  						for(i = 0, j = tmp.children_d.length; i < j; i++) {
  							...
  							if(!tmp2.state.loaded && tmp2.original && tmp2.original.state && tmp2.original.state.undetermined && tmp2.original.state.undetermined === true) {
  								if(o[tmp2.id] === undefined$1 && tmp2.id !== $.jstree.root) {
  									o[tmp2.id] = true;
  									p.push(tmp2.id);
  								}
  								for(k = 0, l = tmp2.parents.length; k < l; k++) {
  									if(o[tmp2.parents[k]] === undefined$1 && tmp2.parents[k] !== $.jstree.root) {
  		...
  		this.check_all = function () {
  			...
  			this._data.checkbox.selected.concat([]); var i, j;
  	...
  	$.jstree.plugins.contextmenu = function (options, parent) {
  		...
  		this.show_contextmenu = function (obj, x, y, e) {
  			...
  			var s = this.settings.contextmenu,
  				...
  				o = false,
  				i = false;
  			if(s.show_at_node || x === undefined$1 || y === undefined$1) {
  				o = a.offset();
  				x = o.left;
  		...
  		$(document)
  			...
  			.on('dnd_move.vakata.jstree', function (e, data) {
  				...
  				var ins = $.jstree.reference(data.event.target),
  					...
  					off = false,
  					rel = false,
  					l, t, h, p, i, o, ok, t1, t2, op, ps, pr, ip, tm, is_copy, pn, c;
  				...
  				if(ins && ins._data && ins._data.dnd) {
  					...
  					if( (data.event.target === ins.element[0] || data.event.target === ins.get_container_ul()[0]) && ins.get_container_ul().children().length === 0) {
  						...
  						if(ref && ref.length && ref.parent().is('.jstree-closed, .jstree-open, .jstree-leaf')) {
  							off = ref.offset();
  							rel = (data.event.pageY !== undefined$1 ? data.event.pageY : data.event.originalEvent.pageY) - off.top;
  							h = ref.outerHeight();
  							if(rel < h / 3) {
  								o = ['b', 'i', 'a'];
  							}
   ...
   */
  	...
  	$.jstree.plugins.search = function (options, parent) {
  		...
  		this.search = function (str, skip_async, show_only_matches, inside, append, show_only_matches_children) {
  			...
  			if(show_only_matches === undefined$1) {
  				show_only_matches = s.show_only_matches;
  			}
  			if(show_only_matches_children === undefined$1) {
   ...
   */
  	...
  	$.jstree.plugins.types = function (options, parent) {
  				...
  				for(i in options.types) {
  					if(i !== "default" && i !== $.jstree.root && options.types.hasOwnProperty(i)) {
  						for(j in options.types['default']) {
  							if(options.types['default'].hasOwnProperty(j) && options.types[i][j] === undefined$1) {
  			...
  			this.element
  				.on('model.jstree', function (e, data) {
  						...
  						for(i = 0, j = dpc.length; i < j; i++) {
  							...
  							m[dpc[i]].type = c;
  							if(m[dpc[i]].icon === true && t[c].icon !== undefined$1) {
  								m[dpc[i]].icon = t[c].icon;
  							}
  							if(t[c].li_attr !== undefined$1 && typeof t[c].li_attr === 'object') {
  								for (k in t[c].li_attr) {
  									if (t[c].li_attr.hasOwnProperty(k)) {
  										if (k === 'id') {
  											continue;
  										}
  										else if (m[dpc[i]].li_attr[k] === undefined$1) {
  							...
  							if(t[c].a_attr !== undefined$1 && typeof t[c].a_attr === 'object') {
  								for (k in t[c].a_attr) {
  									if (t[c].a_attr.hasOwnProperty(k)) {
  										if (k === 'id') {
  											continue;
  										}
  										else if (m[dpc[i]].a_attr[k] === undefined$1) {
  			...
  			switch(chk) {
  				...
  				case "copy_node":
  					if(chk !== 'move_node' || $.inArray(obj.id, par.children) === -1) {
  						...
  						if(tmp.max_children !== undefined$1 && tmp.max_children !== -1 && tmp.max_children === par.children.length) {
  							this._data.core.last_error = { 'error' : 'check', 'plugin' : 'types', 'id' : 'types_01', 'reason' : 'max_children prevents function: ' + chk, 'data' : JSON.stringify({ 'chk' : chk, 'pos' : pos, 'obj' : obj && obj.id ? obj.id : false, 'par' : par && par.id ? par.id : false }) };
  							return false;
  						}
  						if(tmp.valid_children !== undefined$1 && tmp.valid_children !== -1 && $.inArray((obj.type || 'default'), tmp.valid_children) === -1) {
  						...
  						if(d <= 0 || d === undefined$1) { d = 1; }
  						do {
  							if(tmp.max_depth !== undefined$1 && tmp.max_depth !== -1 && tmp.max_depth < d) {
  		...
  		this.get_rules = function (obj) {
  			...
  			if(tmp.max_depth === undefined$1) { tmp.max_depth = -1; }
  			if(tmp.max_children === undefined$1) { tmp.max_children = -1; }
  			if(tmp.valid_children === undefined$1) { tmp.valid_children = -1; }
  			return tmp;
  		};
  		/**
  		...
  		this.set_type = function (obj, type) {
  			...
  			obj.type = type;
  			if(old_icon === true || !t[old_type] || (t[old_type].icon !== undefined$1 && old_icon === t[old_type].icon)) {
  				this.set_icon(obj, t[type].icon !== undefined$1 ? t[type].icon : true);
  			}

  			// remove old type props
  			if(t[old_type] && t[old_type].li_attr !== undefined$1 && typeof t[old_type].li_attr === 'object') {
  			...
  			if(t[old_type] && t[old_type].a_attr !== undefined$1 && typeof t[old_type].a_attr === 'object') {
  			...
  			// add new props
  			if(t[type].li_attr !== undefined$1 && typeof t[type].li_attr === 'object') {
  				for (k in t[type].li_attr) {
  					if (t[type].li_attr.hasOwnProperty(k)) {
  						if (k === 'id') {
  							continue;
  						}
  						else if (m[obj.id].li_attr[k] === undefined$1) {
  			...
  			if(t[type].a_attr !== undefined$1 && typeof t[type].a_attr === 'object') {
  				for (k in t[type].a_attr) {
  					if (t[type].a_attr.hasOwnProperty(k)) {
  						if (k === 'id') {
  							continue;
  						}
  						else if (m[obj.id].a_attr[k] === undefined$1) {
  ...
  function renderStaticHtml(fld, html) {
  ...
  var sampleTl = "\n  <div class=\"tree\">\n  </div>\n  ";
  function applyJtreeAjax(fld) {
    renderStaticHtml(fld, sampleTl);
    var fldId = getAfFieldId(fld);
    promise("#".concat(fldId, " .tree")).then(function () {
      $$1("#".concat(fldId, " .tree")).jstree({
        core: {
          data: {
            url: '/bin/dc/jtree',
  ...
  function printAllVals(dataObj, parentObj) {
    if (parentObj.id === '#') {
      parentObj.children.push({
        id: 'formsanddocuments',
        parent: '#',
        text: 'formsanddocuments'
      });

      for (var i in dataObj) {
        if (_typeof(dataObj[i]) === 'object' && dataObj[i].hasOwnProperty('type') && dataObj[i]['type'] === 'lcFolder') {
          parentObj.children[0].children = true;
        }
      }
    } else {
      for (var _i in dataObj) {
        if (_typeof(dataObj[_i]) === 'object' && dataObj[_i].hasOwnProperty('type') && dataObj[_i]['type'] === 'lcFolder') {
          var obj_i = {
            id: _i,
            parent: parentObj.id,
            text: _i
          };
          parentObj.children.push(obj_i); // set children to true if there are sub children

          for (var _i2 = 0, _Object$entries = Object.entries(dataObj[_i]); _i2 < _Object$entries.length; _i2++) {
            ...
            if (_typeof(value) === 'object' && value.hasOwnProperty('type') && value['type'] === 'lcFolder') {
              obj_i.children = true;
            }
          }
        }
  ...
  var reducer = function reducer(previousValue, currentValue) {
    return currentValue !== '#' ? currentValue + '/' + previousValue : previousValue;
  };

  function aemJson(obj, cb) {
    //let retObj = [{ id: 'formsanddocuments', parent: '#', text: 'formsanddocuments' }];
    //cb.call(this, retObj);
    var url = '/content/dam/formsanddocuments.2.json';

    if (obj.id !== '#') {
      //call ajax with user click
      url = '/content/dam/' + obj.parents.reduce(reducer, obj.id) + '.2.json';
    }

    axios.get(url).then(function (response) {
      // handle success
      printAllVals(response.data, obj);
      cb.call(this, obj.children);
    });
  }

  function applyJtreeJson(fld) {
    renderStaticHtml(fld, sampleTl);
    var fldId = getAfFieldId(fld);
    promise("#".concat(fldId, " .tree")).then(function () {
      $$1("#".concat(fldId, " .tree")).jstree({
  ...
  exports.applyJtreeAjax = applyJtreeAjax;
  exports.applyJtreeJson = applyJtreeJson;
