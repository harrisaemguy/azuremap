(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.dc = global.dc || {}, global.dc.form_gac = {})));
  ...
  function grid2Radio(fld) {
    var gridTpl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : sampleGrid;
    var tplSom = "".concat(fld.panel.somExpression, ".").concat(fld.name, "Template[0]");
    var tplNd = guideBridge.resolveNode(tplSom);

    if (tplNd) {
      gridTpl = tplNd.value;
      /*to avoid print out the template*/

      var tplId = getAfFieldId(tplNd);
      $("#".concat(tplId)).addClass('noPrint');
    }

    var cleanTpl = purify.sanitize(gridTpl, {
      FORCE_BODY: true
    });
    var fldId = getAfFieldId(fld);
    $("#".concat(fldId, " .guideRadioButtonGroupItems")).before(cleanTpl);
    promise("#".concat(fldId, " .rbtn")).then(function () {
      var cells = $("#".concat(fldId, " .rbtn")).empty();
      $("#".concat(fldId, " .guideRadioButtonItem")).each(function (idx, ele) {
        $(ele).css('display', 'flex').appendTo(cells[idx]);
      });
    });
  }
  var sampleChkGrid = "\n<div class=\"grid-container-2\">\n   <div class=\"rbtn\"></div>\n   <div>2</div>\n   <div class=\"rbtn\"></div>\n   <div>4</div>\n   <div class=\"rbtn\"></div>\n   <div>6</div>\n</div>\n";
  function grid2Chkbox(fld) {
    var gridTpl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : sampleChkGrid;
    var tplSom = "".concat(fld.panel.somExpression, ".").concat(fld.name, "Template[0]");
    var tplNd = guideBridge.resolveNode(tplSom);
    ...
    var fldId = getAfFieldId(fld);
    $("#".concat(fldId, " .guideCheckBoxGroupItems")).before(cleanTpl);
    promise("#".concat(fldId, " .rbtn")).then(function () {
      var cells = $("#".concat(fldId, " .rbtn")).empty();
      $("#".concat(fldId, " .guideCheckBoxItem")).each(function (idx, ele) {
        $(ele).css('display', 'flex').appendTo(cells[idx]);
      });
    });
  }
  var sampleC1R4Grid = "\n<div class=\"C1R4\">\n   <div class=\"rbtn\"></div>\n   <div class=\"decoration\">\n      <ul>\n         <li>You Look Amazing.</li>\n         <li>If You Want to Talk, I'm Here.</li>\n      </ul>\n   </div>\n   <div class=\"rbtn\"></div>\n   <div class=\"decoration\">\n      <ul>\n         <li>You're a Great Cook.</li>\n         <li>You're So Creative.</li>\n      </ul>\n   </div>\n</div>\n";
  function grid2RadioLst(fld) {
    var gridTpl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : sampleC1R4Grid;
  ...
  var dataTables_dataTables = {exports: {}};
  	...
  	$(document).on('plugin-init.dt', function (e, context) {
  		...
  		api.on( 'stateSaveParams', function ( e, settings, data ) {
  			var indexes = api.rows().iterator( 'row', function ( settings, idx ) {
  				return settings.aoData[idx]._detailsShow ? idx : undefined$1;
  			});
  ...
  (function( factory ){
  	{
  		...
  		module.exports = function (root, $) {
  			...
  			if ( ! $ || ! $.fn.dataTable ) {
  				...
  				$ = jquery_dataTables.exports(root, $).$;
  			}
  ...
  }(dataTables_dataTables));

  var dt = dataTables_dataTables.exports;

  var keyTable_dataTables = {exports: {}};

  var dataTables_keyTable = {exports: {}};
  ...
  $.extend( KeyTable.prototype, {
  	...
  	_focus: function ( row, column, shift, originalEvent )
  	{
  		...
  		if ( pageInfo.length !== -1 && (row < pageInfo.start || row >= pageInfo.start+pageInfo.length) ) {
  			...
  			dt
  				.one( 'draw', function () {
  					...
  					that._focus( row, column, undefined$1, originalEvent );
  				} )
  		...
  		if ( shift === undefined$1 || shift === true ) {
  ...
  DataTable.Api.register( 'keys.enable()', function ( opts ) {
  	return this.iterator( 'table', function (ctx) {
  		if ( ctx.keytable ) {
  			ctx.keytable.enable( opts === undefined$1 ? true : opts );
  		}
  	} );
  } );
  ...
  (function( factory ){
  	{
  		...
  		module.exports = function (root, $) {
  			...
  			if ( ! $ || ! $.fn.dataTable ) {
  				$ = dataTables_dataTables.exports(root, $).$;
  			}

  			if ( ! $.fn.dataTable.KeyTable ) {
  				dataTables_keyTable.exports(root, $);
  			}
  ...
  var kdt = keyTable_dataTables.exports;
  ...
  function printAllVals(obj) {
    var objPath = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '/content/dam/formsanddocuments';
    var jsObj = arguments[2] || [];

    for (var i in obj) {
      if (_typeof(obj[i]) === 'object') {
        if (obj[i].hasOwnProperty('type') && obj[i]['type'] === 'guide' && obj[i].hasOwnProperty('sling:resourceType') && obj[i]['sling:resourceType'] === 'fd/fm/af/render') {
          var desc = obj[i].metadata.description || '';
          var obj_i = {
        ...
        var subPath = objPath + '/' + i;
        printAllVals(obj[i], subPath, jsObj);
      }
    }
  ...
  function aemJson(tbl) {
    var ajaxUrl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '/content/dam/formsanddocuments.7.json';
    var objPath = ajaxUrl.substring(0, ajaxUrl.indexOf('.'));
    axios.get(ajaxUrl).then(function (response) {
      // handle success
      var jsObj = printAllVals(response.data, objPath);
      jsObj.map(function (item) {
        tbl.row.add(item).draw();
      });
    })["catch"](function (error) {}).then(function () {// always executed
    });
  }

  function applyDataTableAjax(fld) {
    var gridTpl = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : sampleTbl;
    var columns = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : sampleTitles;
    // let user configure rootDir
    var plHld = fld.jsonModel.placeholderText;

    if (plHld && plHld.startsWith('/content/dam/formsanddocuments') && plHld.endsWith('.json')) ; else {
      plHld = '/content/dam/formsanddocuments.7.json';
    }

    var fldId = getAfFieldId(fld);
    $("#".concat(fldId, " input")).hide().after(gridTpl);
    promise("#".concat(fldId, " table")).then(function () {
      var table = $("#".concat(fldId, " table")).DataTable({
        columns: columns,
        pageLength: 5,
        keys: true
      });
  ...
  exports.applyDataTableAjax = applyDataTableAjax;
