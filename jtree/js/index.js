(function (global, factory) {
  ...
  function printAllVals(obj) {
    ...
    for (var i in obj) {
      if (_typeof(obj[i]) === 'object') {
        if (obj[i].hasOwnProperty('type') && obj[i]['type'] === 'lcFolder') {
          var obj_i = {
            id: i,
            parent: 'root',
            text: i
  ...
  function aemJson(obj, cb) {
    axios.get('/content/dam/formsanddocuments.2.json').then(function (response) {
      // handle success
      var jsObj = printAllVals(response.data);
      cb.call(this, jsObj);
    });
  }
